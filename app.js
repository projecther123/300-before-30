...
function renderList() {
  ...
  $('#listStats').textContent =
    `${s.done} of ${s.total} · ${s.pct}% complete`;
...
async function resetToMaster() {
  ...
  try {
    ...
    showError(
      'Reset failed. Your current list may need reloading.'
    );
